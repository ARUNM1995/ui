...
export const verticalMenuItems = [ 
    new Menu (1, 'My Grants', '/stockoptions/mygrants/', null, 'gift', null, false, 0,false),
    new Menu (2, 'My Nominees', '/stockoptions/nominies/', null, 'address-card-o', null, false, 0,false),
    new Menu (3, 'Grants', '/stockoptions/grants/', null, 'database', null, false, 0,true),
    new Menu (4, 'Allocate', '/stockoptions/allocate/', null, 'server', null, false, 0,true),
    new Menu (5, 'Exercise', '/stockoptions/monitization/', null, 'bar-chart', null, false, 0,true),
    new Menu (6, 'Rescind', '/stockoptions/rescind/', null, 'credit-card-alt', null, false, 0,true),
    new Menu (7, 'Reports', '/stockoptions/reports/', null, 'newspaper-o', null, false, 0,false),
    /*
...
export const horizontalMenuItems = [ 
    ...
    new Menu (5, 'Exercise', '/stockoptions/monitization/', null, 'bar-chart', null, false, 0,true),
    new Menu (6, 'Rescind', '/stockoptions/rescind/', null, 'credit-card-alt', null, false, 0,true),
    new Menu (6, 'Reports', '/stockoptions/reports/', null, 'newspaper-o', null, false, 0,false),
